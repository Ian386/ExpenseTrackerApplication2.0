...
Public Class Form3
    ...
    Private Sub Form3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Dim connStr As String = "Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\PC\OneDrive\Documents\EtrackerApp.mdf;Integrated Security=True;Connect Timeout=30;"
    ...
    Private Sub ButtonSubmit_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Using sqlConn As New SqlConnection("Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\PC\OneDrive\Documents\EtrackerApp.mdf;Integrated Security=True;Connect Timeout=30;")
            Try
                ' Open the connection
                sqlConn.Open()
    ...
    Private Sub AddWallet(ByVal name As String, ByVal amount As Decimal, ByVal ownerId As Integer)
        ...
        Dim connectionString As String = "Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\PC\OneDrive\Documents\EtrackerApp.mdf;Integrated Security=True;Connect Timeout=30;"
